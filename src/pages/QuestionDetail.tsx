          ...
          <div className="grid grid-cols-[1fr_280px] gap-6">
            <div className="space-y-6">
              ...
              <div className="glass-card rounded-2xl p-6 space-y-4">
                ...
                <p className="text-base text-muted-foreground leading-relaxed whitespace-pre-wrap">{question.body}</p>
                    ...
                    {answers.map((a, i) => {
                      ...
                      return (
                        <div key={a.id} className={`glass-card rounded-2xl p-5 ${isTop ? "ring-1 ring-primary/30 bg-primary/[0.02]" : ""}`}>
                          ...
                          <p className="text-base leading-relaxed whitespace-pre-wrap mb-4">{a.body}</p>
